...
/**
 * A feature extractor that extracts the total number of segments (e.g. verses, choruses, etc.) in the text.
 * Segments are assumed to be segmented by blank lines, and lines are segmented by line breaks. Lines
 * consisting only of line breaks are filtered out. This count does not include lines consisting only of line
 * breaks.
 *
 * @author Cory McKay
 */
	...
	extends LyricsFeatureExtractor
{
	...
	public NumberOfSegments()
	{
		...
		String name = "Number of Segments";
		String description = "The total number of segments (e.g. verses, choruses, etc.) in the text. " +
				"Segments are assumed to be segmented by blank lines, and lines are segmented by line breaks. " +
				"Lines consisting only of line breaks are filtered out. This count does not include lines " +
