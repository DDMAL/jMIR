     ...
     implements ActionListener
{
      ...
      */
     public RecordingSelectorPanel(OuterFrame outer_frame)
     {
               ...
               if ( files_to_add[i].exists() )
               {
                    try
                    {
                         ...
                         if (validate_recordings_when_load_them_check_box.isSelected())
                              symbolic_sequence = MidiSystem.getSequence(files_to_add[i]);
                    ...
                    {
                         JOptionPane.showMessageDialog(null, "The specified path, " + files_to_add[i].getName() + ", does not refer to a valid file.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    }
                    catch (InvalidMidiDataException e)
                    {
                         JOptionPane.showMessageDialog(null, "The specified file, " + files_to_add[i].getName() + ", is not a valid MIDI file.", "ERROR", JOptionPane.ERROR_MESSAGE);
                    }
               }
               else
               {
     ...
     private void addRecordings()
     {
          ...
          if (load_recording_chooser == null)
          {
               ...
               String[] allowed_extensions = {"mid", "midi"};
     ...
     private void playRecordingDirectly()
     {
          try
          {
               ...
               Sequence midi_sequence = MidiSystem.getSequence(play_file);
