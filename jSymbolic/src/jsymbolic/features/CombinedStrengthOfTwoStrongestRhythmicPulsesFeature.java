/*
 * CombinedStrengthOfTwoStrongestRhythmicPulsesFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the sum of the frequencies of the two beat bins
     ...
     extends MIDIFeatureExtractor
{
     ...
     public CombinedStrengthOfTwoStrongestRhythmicPulsesFeature()
     {
          ...
          String description = "The sum of the frequencies of the two beat bins of the\n" +
