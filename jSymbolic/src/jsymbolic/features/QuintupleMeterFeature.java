...
/**
 * A feature exractor that sets the feature to 1 if numerator of initial time
 * signature is 5, set to 0 otherwise.
 *
     ...
     extends MIDIFeatureExtractor
{
     ...
     public QuintupleMeterFeature()
     {
          ...
          String description = "Set to 1 if numerator of initial time signature is 5,\n" +
               "set to 0 otherwise.";
