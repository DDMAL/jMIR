/*
 * VoiceEqualityRangeFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the standard deviation of the differences
 * between the highest and lowest pitches in each channel that contains at least 
 * one note.
 *
     ...
     extends MIDIFeatureExtractor
{
     ...
     public VoiceEqualityRangeFeature()
     {
          ...
          String description = "Standard deviation of the differences between the highest and lowest\n" +
