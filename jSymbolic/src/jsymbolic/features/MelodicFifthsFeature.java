 ...
 * @author Cory McKay
 */
public class MelodicFifthsFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public MelodicFifthsFeature()
     {
          String name = "Melodic Fifths";
          ...
          throws Exception
     {
          ...
          {
               value = sequence_info.melodic_histogram[7];
          }
          else value = -1.0;
