...
/**
 * A feature exractor that finds the total number of pitch classes used at least
 * once.
 *
     ...
     extends MIDIFeatureExtractor
{
     ...
     public PitchClassVarietyFeature()
     {
          ...
          String description = "Number of pitch classes used at least once.";
          ...
          throws Exception
     {
          ...
          if (sequence_info != null)
          {
               ...
               for (int bin = 0; bin < sequence_info.pitch_class_histogram.length; bin++)
                    if (sequence_info.pitch_class_histogram[bin] > 0.00001)
                         count++;
