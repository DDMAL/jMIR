/*
 * SecondStrongestRhythmicPulseFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the bin label of the beat bin of the peak with
 ...
 * @author Cory McKay
 */
public class SecondStrongestRhythmicPulseFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public SecondStrongestRhythmicPulseFeature()
     {
          String name = "Second Strongest Rhythmic Pulse";
          String description = "Bin label of the beat bin of the peak with the second highest\n" +
               "frequency.";
          ...
          throws Exception
     {
          ...
          if (sequence_info != null)
          {
               ...
               // Calculate the value
               value = (double) second_hidhest_index;
          }
          else value = -1.0;
