/*
 * IntervalBetweenStrongestPitchClassesFeature.java
 * Version 1.2
 *
 ...
 * the pitch classes of the two most common MIDI pitch classes.
 *
 * <p>No extracted feature values are stored in objects of this class.
 *
 * @author Cory McKay
 */
public class IntervalBetweenStrongestPitchClassesFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public IntervalBetweenStrongestPitchClassesFeature()
     {
          String name = "Interval Between Strongest Pitch Classes";
          String description = "Absolute value of the difference between the pitch\n" +
