/*
 * StrengthRatioOfTwoStrongestRhythmicPulsesFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the frequency of the higher (in terms of
 * frequency) of the two beat bins corresponding to the peaks with the highest
 ...
 * @author Cory McKay
 */
public class StrengthRatioOfTwoStrongestRhythmicPulsesFeature
     extends MIDIFeatureExtractor
{
     ...
     public StrengthRatioOfTwoStrongestRhythmicPulsesFeature()
     {
          ...
          String description = "The frequency of the higher (in terms of frequency) of the two beat\n" +
               "bins corresponding to the peaks with the highest frequency divided by\n" +
          ...
          throws Exception
     {
          ...
          if (sequence_info != null)
          {
               ...
               // Calculate the value
               if (max > second_highest)
                    value = max_index / second_highest;
               else
                    value = second_highest / max_index;
          }
          else value = -1.0;
