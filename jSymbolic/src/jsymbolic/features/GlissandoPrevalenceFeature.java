/*
 * GlissandoPrevalenceFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the number of Note Ons that have at least one
 * MIDI Pitch Bend associated with them divided by total number of pitched Note 
 * Ons.
 *
     ...
     extends MIDIFeatureExtractor
{
     ...
     public GlissandoPrevalenceFeature()
     {
          ...
          String description = "Number of Note Ons that have at least one MIDI Pitch Bend associated\n" +
