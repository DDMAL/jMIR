/*
 * MostCommonMelodicIntervalFeature.java
 * Version 1.2
 *
 ...
 * @author Cory McKay
 */
public class MostCommonMelodicIntervalFeature
     extends MIDIFeatureExtractor
{
     ...
     /**
      * Basic constructor that sets the Melodic interval with the highest 
      * frequency.
      */
     public MostCommonMelodicIntervalFeature()
     {
          String name = "Most Common Melodic Interval";
          String description = "Melodic interval with the highest frequency.";
