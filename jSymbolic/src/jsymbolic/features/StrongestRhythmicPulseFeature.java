/*
 * StrongestRhythmicPulseFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the bin label of the beat bin with the highest
 * frequency.
 *
     ...
     extends MIDIFeatureExtractor
{
     ...
     public StrongestRhythmicPulseFeature()
     {
          ...
          String description = "Bin label of the beat bin with the highest frequency.";
