/*
 * NumberOfStrongPulsesFeature.java
 * Version 1.2
 *
 ...
 * @author Cory McKay
 */
public class NumberOfStrongPulsesFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public NumberOfStrongPulsesFeature()
     {
          String name = "Number of Strong Pulses";
          String description = "Number of beat peaks with normalized frequencies over 0.1.";
          ...
          throws Exception
     {
          ...
          if (sequence_info != null)
          {
               ...
               for (int bin = 0; bin < sequence_info.rhythmic_histogram_table.length; bin++)
                    if (sequence_info.rhythmic_histogram_table[bin][0] > 0.001)
                         count++;
