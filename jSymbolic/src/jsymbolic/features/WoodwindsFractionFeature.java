 ...
 * woodwind patches (General MIDI patches 69 or 76).
 *
 * <p>No extracted feature values are stored in objects of this class.
 *
 * @author Cory McKay
 */
public class WoodwindsFractionFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public WoodwindsFractionFeature()
     {
          String name = "Woodwinds Fraction";
          String description = "Fraction of all Note Ons belonging to woodwind patches (General" +
               "MIDI patches 69 or 76).";
