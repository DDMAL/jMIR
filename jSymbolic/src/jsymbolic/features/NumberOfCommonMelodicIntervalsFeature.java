/*
 * NumberOfCommonMelodicIntervalsFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the number of melodic intervals that represent
     ...
     extends MIDIFeatureExtractor
{
     ...
     public NumberOfCommonMelodicIntervalsFeature()
     {
          ...
          String description = "Number of melodic intervals that represent at least\n" +
               "9% of all melodic intervals.";
