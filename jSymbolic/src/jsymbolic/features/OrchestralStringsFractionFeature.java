/*
 * OrchestralStringsFractionFeature.java
 * Version 1.2
 *
 ...
 * orchestral strings patches (General MIDI patches 41 or 47).
 *
 * <p>No extracted feature values are stored in objects of this class.
 *
 * @author Cory McKay
 */
public class OrchestralStringsFractionFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public OrchestralStringsFractionFeature()
     {
          String name = "Orchestral Strings Fraction";
          String description = "Fraction of all Note Ons belonging to orchestral strings patches" +
