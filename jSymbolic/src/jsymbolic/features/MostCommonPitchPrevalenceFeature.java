/*
 * MostCommonPitchPrevalenceFeature.java
 * Version 1.2
 *
 ...
 * @author Cory McKay
 */
public class MostCommonPitchPrevalenceFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public MostCommonPitchPrevalenceFeature()
     {
          String name = "Most Common Pitch Prevalence";
          String description = "Fraction of Note Ons corresponding to the most common pitch.";
