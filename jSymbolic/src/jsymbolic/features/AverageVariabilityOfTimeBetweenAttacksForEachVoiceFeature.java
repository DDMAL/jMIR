/*
 * AverageVariabilityOfTimeBetweenAttacksForEachVoiceFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that extracts the average standard deviation, in seconds, 
 * of time between Note On events on individual channels that contain at least 
 * one note.
 *
     ...
     extends MIDIFeatureExtractor
{
     ...
     public AverageVariabilityOfTimeBetweenAttacksForEachVoiceFeature()
     {
          ...
          String description = "Average standard deviation, in seconds, of time between\n" +
               "Note On events on individual channels that contain at\n" +
               "least one note.";
