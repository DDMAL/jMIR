...
/**
 * A feature exractor that extracts the duration in seconds of a MIDI sequence.
 *
     ...
     extends MIDIFeatureExtractor
{
     ...
     public DurationFeature()
     {
          ...
          String description = "The total duration in seconds of the music.";
