/*
 * NumberOfPitchedInstrumentsFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the total number of General MIDI patches that 
 * are used to play at least one note.
 *
 * <p>No extracted feature values are stored in objects of this class.
 *
 * @author Cory McKay
 */
public class NumberOfPitchedInstrumentsFeature
     extends MIDIFeatureExtractor
{
     ...
     public NumberOfPitchedInstrumentsFeature()
     {
          ...
          String description = "Total number of General MIDI patches that are used to play\n" +
               "at least one note.";
