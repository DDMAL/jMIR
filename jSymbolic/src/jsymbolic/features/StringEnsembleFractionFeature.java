/*
 * StringEnsembleFractionFeature.java
 * Version 1.2
 *
 ...
 * string ensemble patches (General MIDI patches 49 to 52).
 *
 * <p>No extracted feature values are stored in objects of this class.
 *
 * @author Cory McKay
 */
public class StringEnsembleFractionFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public StringEnsembleFractionFeature()
     {
          String name = "String Ensemble Fraction";
          String description = "Fraction of all Note Ons belonging to string ensemble patches" +
