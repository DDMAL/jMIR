/*
 * VoiceEqualityDynamicsFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the standard deviation of the average volume of
 * notes in each channel that contains at least one note.
 *
     ...
     extends MIDIFeatureExtractor
{
     ...
     public VoiceEqualityDynamicsFeature()
     {
          ...
          String description = "Standard deviation of the average volume of notes in each channel that\n" +
