/*
 * RangeOfHighestLineFeature.java
 * Version 1.2
 *
 ...
 * lowest note played in the channel with the highest average pitch divided by
 * the difference between the highest note and the lowest note in the piece.
 *
 * <p>No extracted feature values are stored in objects of this class.
 *
 * @author Cory McKay
 */
public class RangeOfHighestLineFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public RangeOfHighestLineFeature()
     {
          String name = "Range of Highest Line";
          String description = "Difference between the highest note and the lowest note played in the\n" +
               "channel with the highest average pitch divided by the difference between\n" +
               "the highest note and the lowest note in the piece.";
