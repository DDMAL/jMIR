/*
 * DistanceBetweenMostCommonMelodicIntervalsFeature.java
 * Version 1.2
 *
 ...
 * the most common melodic interval and the second most common melodic interval.
 *
 * <p>No extracted feature values are stored in objects of this class.
 *
 * @author Cory McKay
 */
public class DistanceBetweenMostCommonMelodicIntervalsFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public DistanceBetweenMostCommonMelodicIntervalsFeature()
     {
          String name = "Distance Between Most Common Melodic Intervals";
          String description = "Absolute value of the difference between the most common melodic\n" +
               "interval and the second most common melodic interval.";
