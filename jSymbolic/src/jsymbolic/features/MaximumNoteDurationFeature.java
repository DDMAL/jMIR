/*
 * MaximumNoteDurationFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the duration of the longest note (in seconds).
 *
 * <p>No extracted feature values are stored in objects of this class.
 *
 * @author Cory McKay
 */
public class MaximumNoteDurationFeature
     extends MIDIFeatureExtractor
{
     ...
     public MaximumNoteDurationFeature()
     {
          ...
          String description = "Duration of the longest note (in seconds).";
