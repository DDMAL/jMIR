/*
 * VoiceEqualityMelodicLeapsFeature.java
 * Version 1.2
 *
...
/**
 * A feature exractor that finds the standard deviation of the average melodic
 * leap in MIDI pitches for each channel that contains at least one note.
 *
 * <p>No extracted feature values are stored in objects of this class.
 *
 * @author Cory McKay
 */
public class VoiceEqualityMelodicLeapsFeature
	extends MIDIFeatureExtractor
{
	...
	public VoiceEqualityMelodicLeapsFeature()
	{
		...
		String description = "Standard deviation of the average melodic leap in MIDI pitches for each\n" +
