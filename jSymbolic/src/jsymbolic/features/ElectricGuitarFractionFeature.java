/*
 * ElectricGuitarFractionFeature.java
 * Version 1.2
 *
 ...
 * @author Cory McKay
 */
public class ElectricGuitarFractionFeature
     extends MIDIFeatureExtractor
{
      ...
      */
     public ElectricGuitarFractionFeature()
     {
          String name = "Electric Guitar Fraction";
          String description = "Fraction of all Note Ons belonging to electric guitar patches (General" +
