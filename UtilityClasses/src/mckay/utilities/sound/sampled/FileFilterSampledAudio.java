...
/**
 * A file filter for the <code>JFileChooser</code> class. Implements the two
 * methods of the <code>FileFilter</code> abstract class.
 *
 * <p>Filters all files except directories and files that end with .wav, .wave,
 * .aif, .aiff, .aifc, .au,  .snd and mp3 (case is ignored).
 *
 * <p><b>WARNING:</b> Future additions will be made, as the Java SDK comes to
