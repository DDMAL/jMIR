...
public class AudioMethodsPlayback
{
      ...
      *
      * <p>The thread performing the playback is returned to the user, so the
      * user has the option of interrupting it if he or she wishes.
      *
      ...
      * specified <code>SourceDataLine</code>.
      *
      * <p>This playback is not interruptible by the user, and will continue
      * until the <code>AudioInputStream</code> is empty. The
      ...
      * <code>SourceDataLine</code>. Can be interrupded using the
      * <code>stopPlaying</code> method.
      *
      * <p><b>WARNING:</b>Note that the <code>SourceDataLine</code> is closed
      * after playback has terminated. It will need to be reopened if it is to
      * be used elsewhere.
      */
          ...
          extends Thread
     {
          ...
          /**
           * Constructor that performs standard operations of the Thread class
           * as well as setting the source <code>AudioInputStream</code>,
           * setting the target <code>SourceDataLine</code> and initializing an
           * intermediate buffer to hold 1/4 seconds of audio.
           *
           * @throws     Exception Throws an exception if either parameter is
           *                       null.
           * @throws     Exception Throws an exception if the
           *                       <code>AudioFormat</code> of the
           *                       audio_input_stream parameter does not match
          ...
          /**
           * Writes data from the <code>AudioInputStream</code> to the
           * <code>SourceDataLine</code>.
           *
           * <p><b>WARNING:</b>Note that the <code>SourceDataLine</code> is
           * closed after playback has terminated. It will need to be reopened
