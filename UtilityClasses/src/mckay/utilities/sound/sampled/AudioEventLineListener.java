 ...
 *
 * <p>This particular implementation prints data regarding each such event to
 ...
 *
 * <p>Note that all this data may not be available on all systems, as some of 
 * the data parsing that was used may be system specific.
 *
