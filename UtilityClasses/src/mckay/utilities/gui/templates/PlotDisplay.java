 ...
 * Any changes made this way will be manifested when the Replot button is
 * pressed.
 *
 * <p>A simplified version of this class was originally inspired by the Graph01
 * class by R. G. Baldwin.
 *
 * @author Cory McKay
 */
     ...
     implements ActionListener
{
      ...
      *
      * @param evt  The event to be reacted to.
      */
          ...
          extends Canvas
     {
           ...
           *
           * @param	data_set_index		The data set in the data_points
           *                                    field to plot.
           * @param	plot_on_one_graph	Whether or not to plot multiple
           *                                    datasets on this canvas.
           */
